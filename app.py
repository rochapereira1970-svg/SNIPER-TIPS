...
# Estilização CSS Personalizada (Idêntica ao Mestre do Over: Azul Premium)
st.markdown("""
<style>
...
# Mercados Monitorados (Trufo Protegido: Microestatísticas)
st.markdown("""
    <div class="fontes-container">
        ...
        <div class="fonte-tag" style="color: #38bdf8;">⚽ Chutes (Totais / No Gol)</div>
        <div class="fonte-tag" style="color: #10b981;">🟨 Faltas Cometidas</div>
        <div class="fonte-tag" style="color: #eab308;">🏁 Impedimentos</div>
            ...
            st.markdown(f"""
                <div class="card-vip-bloqueado">
                    <div class="card-header" style="border-bottom: 1px solid #222938;">
                        <span class="card-titulo" style="color: #eab308;">🔒 ALVO SECRETO #{i+1} • EXTREMA PRECISÃO</span>
